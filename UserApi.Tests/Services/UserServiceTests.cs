...
public class UserServiceTests : IDisposable
{
    ...
    public async Task CreateUserAsync_WithValidData_ShouldCreateUser()
    {
        ...
        result.Bio.Should().Be(createUserDto.Bio);
    ...
    [Fact]
    public async Task UpdateUserAsync_WithNullBio_ShouldKeepExistingBio()
    {
        // Arrange
        var user = _fixture.Create<User>();
        _context.Users.Add(user);
        ...
        // Assert
        result.Should().NotBeNull();
        result!.Bio.Should().Be(originalBio);
    }
    ...
    [Theory]
    [InlineData("")]
    public async Task UpdateUserAsync_WithEmptyName_ShouldNotUpdateName(string name)
    {
        // Arrange
        var user = _fixture.Create<User>();
        _context.Users.Add(user);
    ...
    [Theory]
    [InlineData("")]
    public async Task UpdateUserAsync_WithEmptyBio_ShouldUpdateBio(string bio)
    {
        // Arrange
        var user = _fixture.Create<User>();
        _context.Users.Add(user);
    ...
    [Fact]
    public async Task UpdateUserAsync_WithNullName_ShouldNotUpdateName()
    {
        // Arrange
        var user = _fixture.Create<User>();
        _context.Users.Add(user);
    ...
    [Fact]
    public async Task UpdateUserAsync_WithUpdatedNameAndNullBio_ShouldPreserveBio()
    {
        // Arrange
        var user = _fixture.Create<User>();
        _context.Users.Add(user);
